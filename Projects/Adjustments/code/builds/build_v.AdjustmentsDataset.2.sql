...
--Pablo Plata
--2/5/2026 
--updated 2/5/2026 to add new fields: StaffTitle, DateOfService, and ADADescription as per Michele's request 
--================================================================
...
-- ====================
-- CTE 4: Operator Data (UPDATED - Added JobTitle)
-- ====================
OperatorData AS (
    SELECT DISTINCT
        URSCID,
        ...
        NAME_FIRST,
        UserLoginName,
        NAME_TITLE  -- NEW: Staff job title
   FROM dentrix.dbo.DDB_RSC_BASE
...
ProcedureCodes AS (
    SELECT 
        ...
        PROC_CODEDB,
        ADACode,
        DESCRIPTION  -- NEW ADA code description (like "Bitewing X-rays", etc.)
...
SELECT 
    ...
    pl.PLDATE as DateOfService,  -- NEW: Date of service (same as adjustment date for adjustments)
    ...
    -- ====================
    -- OPERATOR/USER INFO (UPDATED - Added StaffTitle)
    -- ====================
    ...
    ISNULL(opr.NAME_TITLE, '') as StaffTitle,  -- NEW: Job title (Prime Poster, RCM, etc.)
    ...
    -- ====================
    -- GRID FIELDS From Michele Snapshot 
    -- ====================
    pl.PLDATE as GridDate,
    pl.EncounterNum as GridEncounter,
    
    -- ====================
    -- Procedure Code Info (UPDATED - Added ADA Description)
    -- ====================
    pl.PROC_CODEID as ProcedureCodeID,
    pl.PROC_CODEDB as ProcedureCodeDB,
    pc.ADACode as ProcedureCode,  -- The code like "D0274", "D1110", etc.
    pc.DESCRIPTION as ADADescription,  -- NEW: Description like "Bitewing X-rays", "Adult Prophylaxis"
...
-- ================================================================================================================================================================
/*
1. STAFF TITLE (StaffTitle):
   - Added JobTitle to OperatorData CTE
   - Added StaffTitle field in SELECT (from opr.JobTitle)
   - Shows values like: "Prime Poster", "RCM", "Insurance Team", "Practice Manager", etc.

2. DATE OF SERVICE (DateOfService):
   - Added as pl.PLDATE
   - For adjustments, this is the same as AdjustmentDate
   - Represents when the patient had the work done

3. ADA DESCRIPTION (ADADescription):
   - Added DESCRIPTION to ProcedureCodes CTE
   - Added ADADescription field in SELECT (from pc.DESCRIPTION)
   - Shows procedure descriptions like:
     * D0274 = "Bitewings - Four Radiographic Images"
     * D1110 = "Prophylaxis - Adult"
     * D2391 = "Resin-based Composite - One Surface, Posterior"
     * etc.

FIELD LOCATIONS IN OUTPUT:
- StaffTitle: Right after EnteredByUsername
- DateOfService: At the top with other date fields
- ADADescription: Right after ProcedureCode

ALL THREE FIELDS ARE NOW IN YOUR VIEW!
*/